...
/**
 * This class contains the UDK IMPORTER/UPDATER Inspire Themes Codelist and helper
 * functions, e.g. mapping of searchterms to Inspire Themes.
 * NOTICE: these themes represent a special state (IGC Version). The MOST RECENT 
 * INSPIRE THEMES to be used in IGE etc. can be found in project ingrid-utils !  
 */
