...
public interface IDCStrategy {
    ...
    static String VALUE_IDC_VERSION_5_6_0_e = "5.6.0_e";
	static String VALUE_IDC_VERSION_5_6_0_RELEASE = "5.6.0";

	static String VALUE_IDC_VERSION_5_6_2_RELEASE = "5.6.2";

	static String VALUE_IDC_VERSION_5_7_0_a = "5.7.0_a";
	static String VALUE_IDC_VERSION_5_7_0_RELEASE = "5.7.0";

	static String VALUE_IDC_VERSION_5_7_1_fixConformity = "5.7.1_fixConformity";
	static String VALUE_IDC_VERSION_5_7_1_RELEASE = "5.7.1";

	static String VALUE_IDC_VERSION_5_9_0_a = "5.9.0_a";
	static String VALUE_IDC_VERSION_5_9_0_RELEASE = "5.9.0";

	static String VALUE_IDC_VERSION_5_11_0_a = "5.11.0_a";
	static String VALUE_IDC_VERSION_5_11_0_RELEASE = "5.11.0";

	static String VALUE_IDC_VERSION_5_15_0_a = "5.15.0_a";
	static String VALUE_IDC_VERSION_5_15_0_b = "5.15.0_b";
	
	static String VALUE_IDC_VERSION_6_0_0 = "6.0.0";
	static String VALUE_IDC_VERSION_6_0_1 = "6.0.1";
	static String VALUE_IDC_VERSION_6_1_0_a = "6.1.0_a";
	static String VALUE_IDC_VERSION_6_1_0_b = "6.1.0_b";
	static String VALUE_IDC_VERSION_6_1_0 = "6.1.0";
...
//		VALUE_IDC_VERSION_105_FIX_COUNTRY_CODELIST,
        ...
        VALUE_IDC_VERSION_5_6_0_e,
		VALUE_IDC_VERSION_5_6_0_RELEASE,

		VALUE_IDC_VERSION_5_6_2_RELEASE,

		VALUE_IDC_VERSION_5_7_0_a,
		VALUE_IDC_VERSION_5_7_0_RELEASE,

		VALUE_IDC_VERSION_5_7_1_fixConformity,
		VALUE_IDC_VERSION_5_7_1_RELEASE,

		VALUE_IDC_VERSION_5_9_0_a,
		VALUE_IDC_VERSION_5_9_0_RELEASE,

		VALUE_IDC_VERSION_5_11_0_a,
		VALUE_IDC_VERSION_5_11_0_RELEASE,
			
		VALUE_IDC_VERSION_5_15_0_a,
		VALUE_IDC_VERSION_5_15_0_b,
		VALUE_IDC_VERSION_6_0_0,
		VALUE_IDC_VERSION_6_0_1,
		VALUE_IDC_VERSION_6_1_0_a,
		VALUE_IDC_VERSION_6_1_0_b,
		VALUE_IDC_VERSION_6_1_0
	};
