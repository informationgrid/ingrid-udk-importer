 ...
 * <p>
 * <ul>
 * <li>Add column 'preview_image_description' to table 't01_object', see https://dev.informationgrid.eu/redmine/issues/377</li> 
 * </ul>
 */
public class IDCStrategy4_0_1_a extends IDCStrategyDefault {
    ...
    private void extendDataStructure() throws Exception {
        ...
        log.info( "Add column 'preview_image_description' to table 't01_object' ..." );
        jdbc.getDBLogic().addColumn( "preview_image_description", ColumnType.VARCHAR255, "t01_object", false, null, jdbc );
