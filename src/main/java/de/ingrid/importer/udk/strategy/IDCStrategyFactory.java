...
import de.ingrid.importer.udk.strategy.v601.IDCStrategy6_0_1_RELEASE;
...
public class IDCStrategyFactory {
    ...
    private IDCStrategy getIdcStrategy(String idcVersion) {
        if (idcVersion == null) {
        ...
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_4_0_d)) {
        ...
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_7_1_fixConformity)) {
            return new IDCStrategy5_7_1_fixConformity();
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_7_1_RELEASE)) {
            return new IDCStrategy5_7_1_RELEASE();
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_9_0_a)) {
        ...
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_15_0_a)) {
            ...
            return new IDCStrategy6_0_1_RELEASE();
        } else {
