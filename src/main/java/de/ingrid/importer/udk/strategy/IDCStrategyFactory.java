...
import de.ingrid.importer.udk.strategy.v404.IDCStrategy4_0_4_c;
...
public class IDCStrategyFactory {
    ...
    private IDCStrategy getIdcStrategy(String idcVersion) throws Exception {
        ...
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_4_0_4_c )) {
            return new IDCStrategy4_0_4_c();
        } else {
