...
import de.ingrid.importer.udk.strategy.v500.IDCStrategy5_0_0_a;
...
public class IDCStrategyFactory {
    ...
    private IDCStrategy getIdcStrategy(String idcVersion) throws Exception {
        ...
        } else if (idcVersion.equals( IDCStrategy.VALUE_IDC_VERSION_5_0_0_a )) {
            return new IDCStrategy5_0_0_a();
        } else {
